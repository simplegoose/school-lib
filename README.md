...
**School lib** is a Ruby project for maintaining records of a school library
...
- **Create entities in the school lib**
- **Store data in the database**
- **Check permission for different users**
